...
// node_modules/react-modern-audio-player/dist/index.es.js
var import_react2 = __toESM(require_react());
var import_react_dom = __toESM(require_react_dom());
import "C:/Users/Ростислав/Desktop/TorV/src/frontend/node_modules/react-modern-audio-player/dist/index.css";
...
function stylis_min(W2) {
  function M2(d2, c2, e2, h, a2) {
    for (var m3 = 0, b2 = 0, v2 = 0, n3 = 0, q3, g2, x2 = 0, K2 = 0, k3, u2 = k3 = q3 = 0, l3 = 0, r3 = 0, I2 = 0, t2 = 0, B3 = e2.length, J2 = B3 - 1, y2, f2 = "", p2 = "", F3 = "", G3 = "", C2; l3 < B3; ) {
      g2 = e2.charCodeAt(l3);
      l3 === J2 && 0 !== b2 + n3 + v2 + m3 && (0 !== b2 && (g2 = 47 === b2 ? 10 : 47), n3 = v2 = m3 = 0, B3++, J2++);
      if (0 === b2 + n3 + v2 + m3) {
        ...
        switch (g2) {
          case 123:
                      ...
                      a: {
                        for (u2 = l3 + 1; u2 < J2; ++u2) {
                          switch (e2.charCodeAt(u2)) {
                            case 47:
                              if (42 === g2 && 42 === e2.charCodeAt(u2 - 1) && l3 + 2 !== u2) {
                                l3 = u2 + 1;
                                break a;
                              }
                              break;
            ...
            switch (q3) {
              case 64:
                ...
                k3 = M2(c2, r3, k3, g2, a2 + 1);
                t2 = k3.length;
                0 < A && (r3 = X2(O2, f2, I2), C2 = H2(3, k3, r3, c2, D2, z2, t2, g2, a2, h), f2 = r3.join(""), void 0 !== C2 && 0 === (t2 = (k3 = C2.trim()).length) && (g2 = 0, k3 = ""));
                if (0 < t2)
                  switch (g2) {
                    case 115:
                      f2 = f2.replace(da, ea);
                    ...
                    case 107:
                      ...
                      k3 = f2 + "{" + k3 + "}";
                      k3 = 1 === w2 || 2 === w2 && L2("@" + k3, 3) ? "@-webkit-" + k3 + "@" + k3 : "@" + k3;
                      break;
                    default:
                      k3 = f2 + k3, 112 === h && (k3 = (p2 += k3, ""));
                  }
                else
                  k3 = "";
                break;
              default:
                k3 = M2(c2, X2(c2, f2, I2), k3, h, a2 + 1);
            }
            F3 += k3;
            k3 = I2 = r3 = u2 = q3 = 0;
            f2 = "";
          ...
          case 59:
            ...
            if (1 < (t2 = f2.length))
              switch (0 === u2 && (q3 = f2.charCodeAt(0), 45 === q3 || 96 < q3 && 123 > q3) && (t2 = (f2 = f2.replace(" ", ":")).length), 0 < A && void 0 !== (C2 = H2(1, f2, c2, d2, D2, z2, p2.length, h, a2, h)) && 0 === (t2 = (f2 = C2.trim()).length) && (f2 = "\0\0"), q3 = f2.charCodeAt(0), g2 = f2.charCodeAt(1), q3) {
                case 0:
                  break;
                case 64:
                  if (105 === g2 || 99 === g2) {
                ...
                default:
                  58 !== f2.charCodeAt(t2 - 1) && (p2 += P2(f2, q3, g2, f2.charCodeAt(2)));
              }
            I2 = r3 = u2 = q3 = 0;
            f2 = "";
            g2 = e2.charCodeAt(++l3);
      ...
      switch (g2) {
        case 13:
        case 10:
          47 === b2 ? b2 = 0 : 0 === 1 + q3 && 107 !== h && 0 < f2.length && (r3 = 1, f2 += "\0");
          0 < A * Y2 && H2(0, f2, c2, d2, D2, z2, p2.length, h, a2, h);
          z2 = 1;
          D2++;
          break;
        case 59:
        ...
        default:
          ...
          switch (g2) {
            ...
            case 11:
              ...
              break;
            case 38:
              0 === n3 + b2 + m3 && (r3 = I2 = 1, y2 = "\f" + y2);
              break;
            case 108:
              if (0 === n3 + b2 + m3 + E2 && 0 < u2)
                switch (l3 - u2) {
                  case 2:
                    112 === x2 && 58 === e2.charCodeAt(l3 - 3) && (E2 = x2);
                  case 8:
                    111 === K2 && (E2 = K2);
                }
              break;
              ...
              if (!(0 < n3 + m3 + v2))
                switch (b2) {
                  case 0:
                    ...
                    break;
                  case 42:
                    47 === g2 && 42 === x2 && t2 + 2 !== l3 && (33 === e2.charCodeAt(t2 + 2) && (p2 += e2.substring(t2, l3 + 1)), y2 = "", b2 = 0);
                }
          }
          0 === b2 && (f2 += y2);
      }
    ...
    if (0 < t2) {
      r3 = c2;
      if (0 < A && (C2 = H2(2, p2, r3, d2, D2, z2, t2, h, a2, h), void 0 !== C2 && 0 === (p2 = C2).length))
        return G3 + p2 + F3;
      p2 = r3.join(",") + "{" + p2 + "}";
      if (0 !== w2 * E2) {
        2 !== w2 || L2(p2, 2) || (E2 = 0);
  ...
  function X2(d2, c2, e2) {
    ...
    c2 = h;
    var a2 = h.length, m3 = d2.length;
    switch (m3) {
      case 0:
      case 1:
        var b2 = 0;
        for (d2 = 0 === m3 ? "" : d2[0] + " "; b2 < a2; ++b2) {
    ...
    switch (m3) {
      ...
      case 975:
        ...
        switch (m3 = b2.charCodeAt(0) + (b2.charCodeAt(7) | 0)) {
          ...
          case 207:
          case 102:
            a2 = a2.replace(b2, "-webkit-" + (102 < m3 ? "inline-" : "") + "box") + ";" + a2.replace(b2, "-webkit-" + b2) + ";" + a2.replace(b2, "-ms-" + b2 + "box") + ";" + a2;
        }
        return a2 + ";";
      case 938:
  ...
  function H2(d2, c2, e2, h, a2, m3, b2, v2, n3, q3) {
    for (var g2 = 0, x2 = c2, w3; g2 < A; ++g2) {
      switch (w3 = S2[g2].call(B2, d2, x2, e2, h, a2, m3, b2, v2, n3, q3)) {
        case void 0:
        case false:
        case true:
        case null:
...
function D(e2) {
  ...
  throw false ? new Error("An error occurred. See https://git.io/JUIaE#" + e2 + " for more information." + (n3.length > 0 ? " Args: " + n3.join(", ") : "")) : new Error(R.apply(void 0, [O[e2]].concat(n3)).trim());
}
var j = function() {
  function e2(e3) {
...
var L = function(e2, t2, n3) {
  for (var r3, o2 = n3.split(","), s2 = 0, i2 = o2.length; s2 < i2; s2++)
...
var X = function() {
  function e2(e3, t3, n3) {
    void 0 === e3 && (e3 = w), void 0 === t3 && (t3 = {}), this.options = y({}, J, {}, e3), this.gs = t3, this.names = new Map(n3), this.server = !!e3.isServer, !this.server && C && U && (U = false, function(e4) {
  ...
  return t2.reconstructWithOptions = function(t3, n3) {
    return void 0 === n3 && (n3 = true), new e2(y({}, this.options, {}, t3), this.gs, n3 && this.names || void 0);
  }, t2.allocateGSInstance = function(e3) {
    return this.gs[e3] = (this.gs[e3] || 0) + 1;
  }, t2.getTag = function() {
    return this.tag || (this.tag = (n3 = (t3 = this.options).isServer, r3 = t3.useCSSOMInjection, o2 = t3.target, e3 = n3 ? new W(o2) : r3 ? new H(o2) : new $(o2), new j(e3)));
    var e3, t3, n3, r3, o2;
    ...
    this.registerName(e3, t3), this.getTag().insertRules(V(e3), n3);
...
var oe = function() {
  function e2(e3, t2, n3) {
    this.rules = e3, this.staticRulesId = "", this.isStatic = false, this.componentId = t2, this.baseHash = ee(re, t2), this.baseStyle = n3, X.registerId(t2);
  }
  return e2.prototype.generateAndInjectStyles = function(e3, t2, n3) {
    ...
    if (this.baseStyle && o2.push(this.baseStyle.generateAndInjectStyles(e3, t2, n3)), this.isStatic && !n3.hash)
      if (this.staticRulesId && t2.hasNameForId(r3, this.staticRulesId))
        ...
        var s2 = _e(this.rules, e3, t2, n3).join(""), i2 = Q(ee(this.baseHash, s2) >>> 0);
        if (!t2.hasNameForId(r3, i2)) {
          var a2 = n3(s2, "." + i2, void 0, r3);
          t2.insertRules(r3, i2, a2);
        }
        o2.push(i2), this.staticRulesId = i2;
      }
    else {
      for (var c2 = this.rules.length, u2 = ee(this.baseHash, n3.hash), l3 = "", d2 = 0; d2 < c2; d2++) {
        var h = this.rules[d2];
        if ("string" == typeof h)
          l3 += h, u2 = ee(u2, h + d2);
        else if (h) {
          var p2 = _e(h, e3, t2, n3), f2 = Array.isArray(p2) ? p2.join("") : p2;
          u2 = ee(u2, f2 + d2), l3 += f2;
        }
      }
      if (l3) {
        var m3 = Q(u2 >>> 0);
        if (!t2.hasNameForId(r3, m3)) {
          var y2 = n3(l3, "." + m3, void 0, r3);
          t2.insertRules(r3, m3, y2);
        }
        o2.push(m3);
      }
    }
...
var ie = [":", "[", ".", "#"];
function ae(e2) {
  var t2, n3, r3, o2, s2 = void 0 === e2 ? w : e2, i2 = s2.options, a2 = void 0 === i2 ? w : i2, c2 = s2.plugins, u2 = void 0 === c2 ? S : c2, l3 = new stylis_browser_esm_default(a2), d2 = [], p2 = /* @__PURE__ */ function(e3) {
    function t3(t4) {
      if (t4)
        try {
          e3(t4 + "}");
    ...
    return function(n4, r4, o3, s3, i3, a3, c3, u3, l4, d3) {
      switch (n4) {
        case 1:
    ...
    return 0 === r4 && -1 !== ie.indexOf(s3[n3.length]) || s3.match(o2) ? e3 : "." + t2;
  };
  function m3(e3, s3, i3, a3) {
    void 0 === a3 && (a3 = "&");
    var c3 = e3.replace(se, ""), u3 = s3 && i3 ? i3 + " " + s3 + " { " + c3 + " }" : c3;
    return t2 = a3, n3 = s3, r3 = new RegExp("\\" + n3 + "\\b", "g"), o2 = new RegExp("(\\" + n3 + "\\b){2,}"), l3(i3 || !s3 ? "" : s3, u3);
  }
  return l3.use([].concat(u2, [function(e3, t3, o3) {
    2 === e3 && o3.length && o3[0].lastIndexOf(n3) > 0 && (o3[0] = o3[0].replace(r3, f2));
  }, p2, function(e3) {
    if (-2 === e3) {
      var t3 = d2;
      return d2 = [], t3;
    }
  }])), m3.hash = u2.length ? u2.reduce(function(e3, t3) {
...
function me(e2) {
  var t2 = (0, import_react.useState)(e2.stylisPlugins), n3 = t2[0], s2 = t2[1], c2 = pe(), u2 = (0, import_react.useMemo)(function() {
    var t3 = c2;
    return e2.sheet ? t3 = e2.sheet : e2.target && (t3 = t3.reconstructWithOptions({ target: e2.target }, false)), e2.disableCSSOMInjection && (t3 = t3.reconstructWithOptions({ useCSSOMInjection: false })), t3;
  }, [e2.disableCSSOMInjection, e2.sheet, e2.target]), l3 = (0, import_react.useMemo)(function() {
    return ae({ options: { prefix: !e2.disableVendorPrefixes }, plugins: n3 });
  }, [e2.disableVendorPrefixes, n3]);
  return (0, import_react.useEffect)(function() {
    (0, import_shallowequal.default)(n3, e2.stylisPlugins) || s2(e2.stylisPlugins);
  }, [e2.stylisPlugins]), import_react.default.createElement(ce.Provider, { value: u2 }, import_react.default.createElement(le.Provider, { value: l3 }, true ? import_react.default.Children.only(e2.children) : e2.children));
}
var ye = function() {
  function e2(e3, t2) {
    var n3 = this;
...
function _e(e2, n3, r3, o2) {
  if (Array.isArray(e2)) {
    for (var s2, i2 = [], a2 = 0, c2 = e2.length; a2 < c2; a2 += 1)
      "" !== (s2 = _e(e2[a2], n3, r3, o2)) && (Array.isArray(s2) ? i2.push.apply(i2, s2) : i2.push(s2));
    return i2;
  }
  if (be(e2))
    return "";
  ...
  if (E(e2)) {
    if ("function" != typeof (l3 = e2) || l3.prototype && l3.prototype.isReactComponent || !n3)
      return e2;
    var u2 = e2(n3);
    return (0, import_react_is.isElement)(u2) && console.warn(b(e2) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), _e(u2, n3, r3, o2);
  }
  var l3;
  return e2 instanceof ye ? r3 ? (e2.inject(r3, o2), e2.getName(o2)) : e2 : g(e2) ? function e3(t2, n4) {
    var r4, o3, s3 = [];
    for (var i3 in t2)
      t2.hasOwnProperty(i3) && !be(t2[i3]) && (Array.isArray(t2[i3]) && t2[i3].isCss || E(t2[i3]) ? s3.push(Ee(i3) + ":", t2[i3], ";") : g(t2[i3]) ? s3.push.apply(s3, e3(t2[i3], i3)) : s3.push(Ee(i3) + ": " + (r4 = i3, null == (o3 = t2[i3]) || "boolean" == typeof o3 || "" === o3 ? "" : "number" != typeof o3 || 0 === o3 || r4 in unitless_browser_esm_default || r4.startsWith("--") ? String(o3).trim() : o3 + "px") + ";"));
...
function Ae(e2) {
  for (var t2 = arguments.length, n3 = new Array(t2 > 1 ? t2 - 1 : 0), r3 = 1; r3 < t2; r3++)
    n3[r3 - 1] = arguments[r3];
  return E(e2) || g(e2) ? Ne(_e(v(S, [e2].concat(n3)))) : 0 === n3.length && 1 === e2.length && "string" == typeof e2[0] ? e2 : Ne(_e(v(e2, n3)));
}
...
var Oe = function(e2, t2, n3) {
  return void 0 === n3 && (n3 = w), e2.theme !== n3.theme && e2.theme || t2 || n3.theme;
};
var Re = /[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g;
var De = /(^-|-$)/g;
function je(e2) {
...
function Be(e2, t2, n3) {
  var r3 = e2[n3];
  ke(t2) && ke(r3) ? ze(r3, t2) : e2[n3] = t2;
}
function ze(e2) {
  for (var t2 = arguments.length, n3 = new Array(t2 > 1 ? t2 - 1 : 0), r3 = 1; r3 < t2; r3++)
    n3[r3 - 1] = arguments[r3];
...
function Ye(e2, t2, n3) {
  var o2 = _(e2), i2 = !xe(e2), a2 = t2.attrs, c2 = void 0 === a2 ? S : a2, l3 = t2.componentId, d2 = void 0 === l3 ? function(e3, t3) {
    var n4 = "string" != typeof e3 ? "sc" : je(e3);
    Fe[n4] = (Fe[n4] || 0) + 1;
  ...
  o2 && e2.shouldForwardProp && (N2 = t2.shouldForwardProp ? function(n4, r3, o3) {
    return e2.shouldForwardProp(n4, r3, o3) && t2.shouldForwardProp(n4, r3, o3);
  } : e2.shouldForwardProp);
  var A, C2 = new oe(n3, v2, o2 ? e2.componentStyle : void 0), I2 = C2.isStatic && 0 === c2.length, P2 = function(e3, t3) {
    return function(e4, t4, n4, r3) {
      var o3 = e4.attrs, i3 = e4.componentStyle, a3 = e4.defaultProps, c3 = e4.foldedComponentIds, l4 = e4.shouldForwardProp, d3 = e4.styledComponentId, h2 = e4.target, p3 = function(e5, t5, n5) {
        void 0 === e5 && (e5 = w);
        var r4 = y({}, t5, { theme: e5 }), o4 = {};
        return n5.forEach(function(e6) {
          var t6, n6, s2, i4 = e6;
          for (t6 in E(i4) && (i4 = i4(r4)), i4)
            r4[t6] = o4[t6] = "className" === t6 ? (n6 = o4[t6], s2 = i4[t6], n6 && s2 ? n6 + " " + s2 : n6 || s2) : i4[t6];
        }), [r4, o4];
      }(Oe(t4, (0, import_react.useContext)(Me), a3) || w, t4, o3), m3 = p3[0], v3 = p3[1], g3 = function(e5, t5, n5, r4) {
        var o4 = pe(), s2 = fe(), i4 = t5 ? e5.generateAndInjectStyles(w, o4, s2) : e5.generateAndInjectStyles(n5, o4, s2);
        return !t5 && r4 && r4(i4), i4;
      }(i3, r3, m3, true ? e4.warnTooManyClasses : void 0), S2 = n4, b2 = v3.$as || t4.$as || v3.as || t4.as || h2, _2 = xe(b2), N3 = v3 !== t4 ? y({}, t4, {}, v3) : t4, A2 = {};
      for (var C3 in N3)
  ...
  return P2.displayName = p2, (A = import_react.default.forwardRef(P2)).attrs = g2, A.componentStyle = C2, A.displayName = p2, A.shouldForwardProp = N2, A.foldedComponentIds = o2 ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : S, A.styledComponentId = v2, A.target = o2 ? e2.target : e2, A.withComponent = function(e3) {
    ...
    return Ye(e3, y({}, o3, { attrs: g2, componentId: s2 }), n3);
...
var qe = function(e2) {
  return function e3(t2, r3, o2) {
    ...
    return s2.withConfig = function(n3) {
      return e3(t2, r3, y({}, o2, {}, n3));
    }, s2.attrs = function(n3) {
      return e3(t2, r3, y({}, o2, { attrs: Array.prototype.concat(o2.attrs, n3).filter(Boolean) }));
    }, s2;
  }(Ye, e2);
};
...
var He = function() {
  ...
  return t2.createStyles = function(e3, t3, n3, r3) {
    var o2 = r3(_e(this.rules, t3, n3, r3).join(""), ""), s2 = this.componentId + e3;
    n3.insertRules(s2, s2, o2);
  }, t2.removeStyles = function(e3, t3) {
    t3.clearRules(this.componentId + e3);
  }, t2.renderStyles = function(e3, t3, n3, r3) {
    e3 > 2 && X.registerId(this.componentId + e3), this.removeStyles(e3, n3), this.createStyles(e3, t3, n3, r3);
  }, e2;
}();
function $e(e2) {
  for (var t2 = arguments.length, n3 = new Array(t2 > 1 ? t2 - 1 : 0), o2 = 1; o2 < t2; o2++)
    n3[o2 - 1] = arguments[o2];
  var i2 = Ae.apply(void 0, [e2].concat(n3)), a2 = "sc-global-" + Te(JSON.stringify(i2)), u2 = new He(i2, a2);
  function d2(e3) {
    var t3 = pe(), n4 = fe(), o3 = (0, import_react.useContext)(Me), d3 = (0, import_react.useRef)(t3.allocateGSInstance(a2)).current;
    ...
    }) && console.warn("Please do not use @import CSS syntax in createGlobalStyle at this time, as the CSSOM APIs we use in production do not handle it well. Instead, we recommend using a library such as react-helmet to inject a typical <link> meta tag to the stylesheet, or simply embedding it manually in your index.html <head> section for a simpler app."), t3.server && h(d3, e3, t3, o3, n4), (0, import_react.useLayoutEffect)(function() {
      if (!t3.server)
        return h(d3, e3, t3, o3, n4), function() {
          return u2.removeStyles(d3, t3);
        };
    }, [d3, e3, t3, o3, n4]), null;
  }
  function h(e3, t3, n4, r3, o3) {
    if (u2.isStatic)
      u2.renderStyles(e3, P, n4, o3);
    else {
      var s2 = y({}, t3, { theme: Oe(t3, r3, d2.defaultProps) });
...
function We(e2) {
  ...
  for (var t2 = arguments.length, n3 = new Array(t2 > 1 ? t2 - 1 : 0), r3 = 1; r3 < t2; r3++)
    n3[r3 - 1] = arguments[r3];
  var o2 = Ae.apply(void 0, [e2].concat(n3)).join(""), s2 = Te(o2);
  return new ye(s2, o2);
}
var Ue = function() {
  function e2() {
    ...
    this._emitSheetCSS = function() {
      ...
      if (e3.sealed)
        return D(2);
      var n3 = ((t3 = {})[N] = "", t3["data-styled-version"] = "5.3.11", t3.dangerouslySetInnerHTML = { __html: e3.instance.toString() }, t3), o2 = Y();
...
function $704cf1d3b684cc5c$export$535bd6ca7f90a273() {
  ...
  let [isSSR, setIsSSR] = (0, import_react2.useState)(isInSSRContext);
  ...
  if ("string" == typeof e2 || "number" == typeof e2)
    ...
    if (Array.isArray(e2))
      for (t2 = 0; t2 < e2.length; t2++)
        e2[t2] && (f2 = r2(e2[t2])) && (n22 && (n22 += " "), n22 += f2);
    else
      for (t2 in e2)
        e2[t2] && (n22 && (n22 += " "), n22 += t2);
  return n22;
}
function clsx() {
  for (var e2, t2, f2 = 0, n22 = ""; f2 < arguments.length; )
    (e2 = arguments[f2++]) && (t2 = r2(e2)) && (n22 && (n22 += " "), n22 += t2);
  return n22;
}
typeof window !== "undefined" ? import_react2.default.useLayoutEffect : () => {
};
...
var $18f2051aff69b9bf$var$I18nContext = import_react2.default.createContext(null);
function $18f2051aff69b9bf$export$a54013f0d02a8f82(props) {
  ...
  return import_react2.default.createElement($18f2051aff69b9bf$var$I18nContext.Provider, {
    value
  }, children);
}
...
function $3df547e395c4522f$export$32d5543ab307c01(query) {
  ...
  let [matches, setMatches] = (0, import_react2.useState)(
...
function $98e5a8ae0e6415af$export$c2c55ef9111cafd8(ref) {
  let domRef = (0, import_react2.useRef)(null);
...
var $1051245f87c5981d$var$Context = import_react2.default.createContext(null);
...
function $1051245f87c5981d$export$8214320346cf5104(props) {
  ...
  return import_react2.default.createElement($1051245f87c5981d$var$Context.Provider, {
    value: {
      matchedBreakpoints
    }
  }, children);
...
function $1051245f87c5981d$export$140ae7baa51cca23(breakpoints) {
  ...
  let [breakpoint1, setBreakpoint] = (0, import_react2.useState)(
...
function $1051245f87c5981d$export$199d6754bdf4e1e3() {
  return (0, import_react2.useContext)($1051245f87c5981d$var$Context);
}
...
var $59d09bcc83651bf9$var$SlotContext = import_react2.default.createContext(null);
function $59d09bcc83651bf9$export$1e5c9e6e4e15efe3(props, defaultSlot) {
  let slot = props.slot || defaultSlot;
  let { [slot]: slotProps = {} } = (0, import_react2.useContext)($59d09bcc83651bf9$var$SlotContext) || {};
...
function $59d09bcc83651bf9$export$ceb145244332b7a2(props) {
  ...
  if (import_react2.default.Children.toArray(children).length <= 1) {
    if (typeof children === "function")
      content = import_react2.default.cloneElement(import_react2.default.Children.only(children), otherProps);
  }
  return import_react2.default.createElement($59d09bcc83651bf9$var$SlotContext.Provider, {
    value: {}
  }, content);
}
var $f57aed4a881a3485$var$Context = import_react2.default.createContext(null);
function $f57aed4a881a3485$export$178405afcd8c5eb(props) {
  ...
  return import_react2.default.createElement($f57aed4a881a3485$var$Context.Provider, {
    value: context
  }, children);
}
...
function $parcel$export$2(e2, n22, v2, s2) {
  Object.defineProperty(e2, n22, { get: v2, set: s2, enumerable: true, configurable: true });
}
var $698974e9dd92c2ec$exports = {};
$parcel$export$2($698974e9dd92c2ec$exports, "spectrum", () => $698974e9dd92c2ec$export$3311ab3a441bc141, (v2) => $698974e9dd92c2ec$export$3311ab3a441bc141 = v2);
...
$parcel$export$2($5cac98e4c80e6707$exports, "spectrum", () => $5cac98e4c80e6707$export$3311ab3a441bc141, (v2) => $5cac98e4c80e6707$export$3311ab3a441bc141 = v2);
$parcel$export$2($5cac98e4c80e6707$exports, "spectrum-Body", () => $5cac98e4c80e6707$export$a30bf7810c8453d1, (v2) => $5cac98e4c80e6707$export$a30bf7810c8453d1 = v2);
$parcel$export$2($5cac98e4c80e6707$exports, "spectrum-Body--italic", () => $5cac98e4c80e6707$export$7b2dac1166f6ec4c, (v2) => $5cac98e4c80e6707$export$7b2dac1166f6ec4c = v2);
...
var $7167f8da3cce35e4$var$Context = import_react2.default.createContext(null);
...
function $7167f8da3cce35e4$var$Provider(props, ref) {
  ...
  if (!prevContext || props.locale || theme !== prevContext.theme || colorScheme !== prevContext.colorScheme || scale !== prevContext.scale || Object.keys(domProps).length > 0 || otherProps.UNSAFE_className || Object.keys(styleProps.style).length > 0)
    contents = import_react2.default.createElement($7167f8da3cce35e4$var$ProviderWrapper, {
      ...props,
      UNSAFE_style: {
  ...
  return import_react2.default.createElement($7167f8da3cce35e4$var$Context.Provider, {
    value: context
  }, import_react2.default.createElement($18f2051aff69b9bf$export$a54013f0d02a8f82, {
    locale
  }, import_react2.default.createElement($1051245f87c5981d$export$8214320346cf5104, {
    matchedBreakpoints
  }, import_react2.default.createElement($f57aed4a881a3485$export$178405afcd8c5eb, null, contents))));
}
var $7167f8da3cce35e4$export$2881499e37b75b9a = import_react2.default.forwardRef($7167f8da3cce35e4$var$Provider);
var $7167f8da3cce35e4$var$ProviderWrapper = import_react2.default.forwardRef(function ProviderWrapper(props, ref) {
  let { children, ...otherProps } = props;
  ...
  let className = clsx(styleProps.className, $parcel$interopDefault$2($698974e9dd92c2ec$exports)["spectrum"], $parcel$interopDefault$2($5cac98e4c80e6707$exports)["spectrum"], theme[colorScheme][themeKey], theme[scale][scaleKey], theme.global ? Object.values(theme.global) : null, {
  ...
  let style = {
    ...
    colorScheme: (ref1 = (_colorScheme = props.colorScheme) !== null && _colorScheme !== void 0 ? _colorScheme : colorScheme) !== null && ref1 !== void 0 ? ref1 : Object.keys(theme).filter(
      (k22) => k22 === "light" || k22 === "dark"
    ).join(" ")
  };
  let hasWarned = (0, import_react2.useRef)(false);
  (0, import_react2.useEffect)(() => {
...
function $7167f8da3cce35e4$export$693cdb10cec23617() {
  return (0, import_react2.useContext)($7167f8da3cce35e4$var$Context);
}
function $parcel$interopDefault$1(a2) {
  return a2 && a2.__esModule ? a2.default : a2;
}
function $parcel$export$1(e2, n22, v2, s2) {
  Object.defineProperty(e2, n22, { get: v2, set: s2, enumerable: true, configurable: true });
}
var $ea2e8e3460b67692$exports = {};
$parcel$export$1($ea2e8e3460b67692$exports, "spectrum--darkest", () => $ea2e8e3460b67692$export$4ecdba604f5f1f44, (v2) => $ea2e8e3460b67692$export$4ecdba604f5f1f44 = v2);
...
$parcel$export$1($5b6ea5874ed9af7b$exports, "spectrum", () => $5b6ea5874ed9af7b$export$3311ab3a441bc141, (v2) => $5b6ea5874ed9af7b$export$3311ab3a441bc141 = v2);
$parcel$export$1($5b6ea5874ed9af7b$exports, "spectrum--medium", () => $5b6ea5874ed9af7b$export$4c0c83b3f4303ef8, (v2) => $5b6ea5874ed9af7b$export$4c0c83b3f4303ef8 = v2);
$parcel$export$1($5b6ea5874ed9af7b$exports, "spectrum--large", () => $5b6ea5874ed9af7b$export$a88a8dbe29386d31, (v2) => $5b6ea5874ed9af7b$export$a88a8dbe29386d31 = v2);
$parcel$export$1($5b6ea5874ed9af7b$exports, "spectrum--darkest", () => $5b6ea5874ed9af7b$export$4ecdba604f5f1f44, (v2) => $5b6ea5874ed9af7b$export$4ecdba604f5f1f44 = v2);
$parcel$export$1($5b6ea5874ed9af7b$exports, "spectrum--dark", () => $5b6ea5874ed9af7b$export$68dc111a79481afd, (v2) => $5b6ea5874ed9af7b$export$68dc111a79481afd = v2);
$parcel$export$1($5b6ea5874ed9af7b$exports, "spectrum--light", () => $5b6ea5874ed9af7b$export$efb37c2f79da8163, (v2) => $5b6ea5874ed9af7b$export$efb37c2f79da8163 = v2);
$parcel$export$1($5b6ea5874ed9af7b$exports, "spectrum--lightest", () => $5b6ea5874ed9af7b$export$baaa804dc80cce18, (v2) => $5b6ea5874ed9af7b$export$baaa804dc80cce18 = v2);
...
$parcel$export$1($b2eefcc3e5fdb373$exports, "spectrum--large", () => $b2eefcc3e5fdb373$export$a88a8dbe29386d31, (v2) => $b2eefcc3e5fdb373$export$a88a8dbe29386d31 = v2);
...
$parcel$export$1($729ae839c55d8d77$exports, "spectrum--light", () => $729ae839c55d8d77$export$efb37c2f79da8163, (v2) => $729ae839c55d8d77$export$efb37c2f79da8163 = v2);
...
$parcel$export$1($b4d117254fac085c$exports, "spectrum--medium", () => $b4d117254fac085c$export$4c0c83b3f4303ef8, (v2) => $b4d117254fac085c$export$4c0c83b3f4303ef8 = v2);
...
var useNonNullableContext = (context) => {
  const state = (0, import_react2.useContext)(context);
  if (!state)
    throw new Error(`${context} is not provided or null`);
  return state;
};
var defaultInterfacePlacementMaxLength = 10;
var defaultInterfacePlacement = {
  templateArea: {
    artwork: "row1-1",
    trackInfo: "row1-2",
...
var audioPlayerStateContext = (0, import_react2.createContext)(null);
function getDefaultExportFromCjs(x2) {
  return x2 && x2.__esModule && Object.prototype.hasOwnProperty.call(x2, "default") ? x2["default"] : x2;
}
var jsxRuntime = { exports: {} };
var reactJsxRuntime_production_min = {};
var f = import_react2.default;
...
function q2(c2, a2, g2) {
  ...
  for (b2 in a2)
    m2.call(a2, b2) && !p.hasOwnProperty(b2) && (d2[b2] = a2[b2]);
  if (c2 && c2.defaultProps)
    for (b2 in a2 = c2.defaultProps, a2)
      void 0 === d2[b2] && (d2[b2] = a2[b2]);
  return { $$typeof: k2, type: c2, key: e2, ref: h, props: d2, _owner: n2.current };
}
...
var SpectrumProvider = ({
  ...
  const [placementState, setPlacementState] = (0, import_react2.useState)();
  (0, import_react2.useLayoutEffect)(() => {
  ...
  return jsx($7167f8da3cce35e4$export$2881499e37b75b9a, {
...
var audioPlayerDispatchContext = (0, import_react2.createContext)(null);
var getRandomNumber = (min, max) => {
  return Math.round(Math.random() * (max - min) + min);
};
var getTimeWithPadStart = (time) => {
  const minutes = `${Math.floor(time / 60)}`.padStart(2, "0");
  const seconds = `${Math.floor(time % 60)}`.padStart(2, "0");
  return `${minutes}:${seconds}`;
};
var resetAudioValues = (elementRefs, duration, restart) => {
  if (!elementRefs)
    return;
  const {
    progressHandleEl,
...
var getRandomIdx = (curIdx, minNumber, maxNumber) => {
...
var audioPlayerReducer = (state, action) => {
  var _a, _b, _c, _d;
  switch (action.type) {
    case "NEXT_AUDIO": {
...
var AudioPlayerProvider = ({
  ...
  const [audioContextState, dispatchAudioContextState] = (0, import_react2.useReducer)(audioPlayerReducer, {
    playList,
  ...
  return jsx(audioPlayerStateContext.Provider, {
    value: audioContextState,
    children: jsx(audioPlayerDispatchContext.Provider, {
...
function $b9606c0c41d55371$var$View(props, ref) {
  ...
  return import_react2.default.createElement(ElementType, {
    ...
    ...styleProps,
    ref: domRef
  }, import_react2.default.createElement($59d09bcc83651bf9$export$ceb145244332b7a2, null, children));
}
var $b9606c0c41d55371$export$27a5bd065ad55220 = (0, import_react2.forwardRef)($b9606c0c41d55371$var$View);
var useAudio = () => {
  const { curAudioState, elementRefs } = useNonNullableContext(
    audioPlayerStateContext
  );
  const audioPlayerDispatch = useNonNullableContext(audioPlayerDispatchContext);
  const onTimeUpdate = (0, import_react2.useCallback)(
    (event) => {
  ...
  const onEnded = (0, import_react2.useCallback)(() => {
  ...
  const onLoadedMetadata = (0, import_react2.useCallback)(
    (e2) => {
      if (!elementRefs)
        return;
      const { duration } = e2.currentTarget;
...
var StyledBtn = styled_components_browser_esm_default.button`
  display: flex;
  width: 20px;
  height: 100%;
  svg {
...
var __assign = globalThis && globalThis.__assign || function() {
  __assign = Object.assign || function(t2) {
    for (var s2, i2 = 1, n22 = arguments.length; i2 < n22; i2++) {
      s2 = arguments[i2];
      for (var p2 in s2)
...
var StyledPlayBtn = styled_components_browser_esm_default(StyledBtn)`
  width: 35px;
`;
var PlayBtn = () => {
  const {
  ...
  const PlayIcon = (0, import_react2.useMemo)(() => {
    if (curAudioState.isPlaying)
      return jsx(Icon, {
        render: jsx(MdPauseCircleFilled, {}),
        customIcon: customIcons == null ? void 0 : customIcons.pause
      });
    return jsx(Icon, {
      render: jsx(MdPlayCircleFilled, {}),
...
var PrevNnextBtn = ({
  ...
  const PrevNnextIcon = (0, import_react2.useMemo)(() => {
    if (type === "next") {
      return jsx(Icon, {
        render: jsx(ImNext, {}),
...
var RepeatTypeBtn = () => {
  ...
  const audioPlayerDispatch = useNonNullableContext(audioPlayerDispatchContext);
  const changeRepeatType = (0, import_react2.useCallback)(() => {
  ...
  const RepeatIcon = (0, import_react2.useMemo)(() => {
    switch (curAudioState.repeatType) {
      case "ALL":
        return jsx(Icon, {
          render: jsx(TbRepeat, {}),
  ...
  return jsx(StyledBtn, {
    onClick: changeRepeatType,
    className: "repeat-button",
    children: RepeatIcon
  });
};
var PlayListTriggerBtn = ({
  isOpen
}) => {
  const {
    customIcons
...
var VolumeTriggerBtn = (0, import_react2.forwardRef)((_2, ref) => {
  const {
    curAudioState,
    customIcons,
    elementRefs
  ...
  const audioPlayerDispatch = useNonNullableContext(audioPlayerDispatchContext);
  const changeMuteState = (0, import_react2.useCallback)(() => audioPlayerDispatch({
    type: "SET_MUTED",
    muted: !curAudioState.muted
  }), [audioPlayerDispatch, curAudioState.muted]);
  const VolumeIcon = (0, import_react2.useMemo)(() => {
    var _a;
    const volumeOpt = {
      size: "100%"
    };
...
var drawerContext = (0, import_react2.createContext)(null);
var appearanceIn = We({
  "0%": {
    opacity: 0,
...
var CssTransition = ({
  ...
  const [classNames2, setClassNames] = (0, import_react2.useState)("");
  const [renderable, setRenderable] = (0, import_react2.useState)(false);
  (0, import_react2.useLayoutEffect)(() => {
...
var Drawer = ({
  ...
  const [trigger, content] = import_react2.default.Children.toArray(children);
...
var DrawerContainer = styled_components_browser_esm_default.div`
  position: relative;
  min-width: 20px;
  min-height: 20px;
...
var DrawerContent = ({
  ...
  const Content = (0, import_react2.useMemo)(() => jsx("div", {
    className: "drawer-content-container",
    children
  }), [children]);
  return isWithAnimation ? jsx(CssTransition, {
    visible: isOpen,
...
var SortableList = ({
  ...
  return jsx(SortableListContainer, {
    className: "sortable-list-container",
    children
  });
};
var SortableListContainer = styled_components_browser_esm_default.ul`
  ul,
  li {
...
function $parcel$export(e2, n22, v2, s2) {
  Object.defineProperty(e2, n22, { get: v2, set: s2, enumerable: true, configurable: true });
}
...
var $994c48bfb00b620b$export$ef2184bd89960b14 = (0, import_react2.forwardRef)($994c48bfb00b620b$var$Grid);
var $01dd1839b5376a46$exports = {};
$parcel$export($01dd1839b5376a46$exports, "flex-container", () => $01dd1839b5376a46$export$69d7a39fa31a000b, (v2) => $01dd1839b5376a46$export$69d7a39fa31a000b = v2);
$parcel$export($01dd1839b5376a46$exports, "flex", () => $01dd1839b5376a46$export$97691fbb80847c19, (v2) => $01dd1839b5376a46$export$97691fbb80847c19 = v2);
$parcel$export($01dd1839b5376a46$exports, "flex-gap", () => $01dd1839b5376a46$export$31a9da8b58047a44, (v2) => $01dd1839b5376a46$export$31a9da8b58047a44 = v2);
...
function $884c64d19340d345$var$Flex(props, ref) {
  ...
  if ((props.gap || props.rowGap || props.columnGap) && (isSSR || !$884c64d19340d345$var$isFlexGapSupported())) {
    ...
    return import_react2.default.createElement("div", {
      ...$65484d02dcb7eb3e$export$457c3d6518dd4c6f(otherProps),
      ...styleProps,
      className: $fd933927dbac1f15$export$ce4ab0c55987d1ff($parcel$interopDefault($01dd1839b5376a46$exports), "flex-container", styleProps.className),
      ref: domRef
    }, import_react2.default.createElement("div", {
      className: $fd933927dbac1f15$export$ce4ab0c55987d1ff($parcel$interopDefault($01dd1839b5376a46$exports), "flex", "flex-gap"),
      style: style2
    }, children));
  }
  let style = {
...
var $884c64d19340d345$export$f51f4c4ede09e011 = (0, import_react2.forwardRef)($884c64d19340d345$var$Flex);
var useSortableListItem = ({
  index,
  dragStartIdx,
  listData,
  draggable = true,
  ...
  return {
    ...
    onDragStart: (e2) => {
      e2.stopPropagation();
      e2.currentTarget.classList.add("dragstart");
      onDragStartCb && onDragStartCb(e2);
    },
    onDragEnd: (e2) => {
      e2.stopPropagation();
      e2.currentTarget.classList.remove("dragstart");
    },
    onDragEnter: (e2) => {
      e2.stopPropagation();
      e2.currentTarget.classList.add("dragover");
    },
    onDragLeave: (e2) => {
      e2.stopPropagation();
      e2.currentTarget.classList.remove("dragover");
    },
    onDragOver: (e2) => {
      e2.preventDefault();
      e2.stopPropagation();
      onDragOverCb && onDragOverCb(e2);
    },
    onDrop: (e2) => {
      e2.stopPropagation();
      e2.currentTarget.classList.remove("dragover");
      ...
      onDropCb && onDropCb(e2, newListData);
    },
    onClick: (e2) => {
      e2.stopPropagation();
      onClickCb && onClickCb(e2);
    }
  };
};
var SortableListItem = (props) => {
  const {
    children,
    ...useListItemProps
  } = props;
  const eventProps = useSortableListItem(useListItemProps);
  return jsx(SortableListItemContainer, {
    className: "list-item-root-container",
    ...eventProps,
    children: jsx($884c64d19340d345$export$f51f4c4ede09e011, {
      alignItems: "center",
      children
    })
  });
};
var SortableListItemContainer = styled_components_browser_esm_default.li`
...
var ListItemContainer = styled_components_browser_esm_default.div`
  width: 100%;
  height: 100%;
  display: flex;
  align-items: center;
...
var usePlayList = ({
  ...
  const audioPlayerDispatch = useNonNullableContext(audioPlayerDispatchContext);
  const [dragStartIdx, setDragStartIdx] = (0, import_react2.useState)(0);
  const onClickItem = (0, import_react2.useCallback)(
    (index) => {
      audioPlayerDispatch({
  ...
  return {
    ...
    sortableItemEventProps: {
      ...
      onDrop: (e2, newPlayList) => audioPlayerDispatch({
...
var PlayList = ({
  ...
  return playList.length !== 0 ? import_react_dom.default.createPortal(jsx(CssTransition, {
    visible: isOpen,
    ...
    clearTime: 300,
    ...cssTransitionEventProps,
    children: jsx(PlayListContainer, {
      className: "play-list-container",
      children: jsx(SortableList, {
        children: playList.map((data, index) => jsx(SortableList.Item, {
          index,
          listData: playList,
          onClick: () => onClickItem(index),
          onDragStart: () => onDragStartItem(index),
          ...otherSortableItemEventProps,
          children: jsx(PlayListItem, {
            data
          })
        }, `sortable-item-${index}`))
      })
    })
  }), document.querySelector(".sortable-play-list")) : jsx(Fragment, {});
};
var PlayListContainer = styled_components_browser_esm_default.div`
...
var SortablePlayList = () => {
  ...
  return jsxs(Drawer, {
    ...
    children: [jsx(Drawer.Trigger, {
      children: jsx(PlayListTriggerBtn, {
        isOpen
      })
    }), jsx(Drawer.Content, {
      children: jsx(PlayList, {
        isOpen,
        setIsOpen
      })
    })]
...
var useVariableColor = (variableColors) => {
  const colorsRef = (0, import_react2.useRef)();
  (0, import_react2.useLayoutEffect)(() => {
...
var useProgress = () => {
  ...
  const [isTimeChangeActive, setTimeChangeActive] = (0, import_react2.useState)(false);
  const moveAudioTime = (0, import_react2.useCallback)(
    (e2) => {
  ...
  const setSelectStartActive = (0, import_react2.useCallback)(
...
var BarProgress = ({
  ...
  const progressValueRef = (0, import_react2.useRef)(null);
  const progressHandleRef = (0, import_react2.useRef)(null);
  useRefsDispatch({
    refs: {
  ...
  return isActive ? jsxs(BarProgressWrapper, {
...
var BarProgressWrapper = styled_components_browser_esm_default.div`
  display: flex;
  width: 100%;
  height: 18px;
  padding: 8px 0;
      ...
      var __webpack_modules__ = {
        "./src/drawer.canvasentry.js": (module2, exports2, __webpack_require__2) => {
          ...
          var CanvasEntry = function() {
            ...
            _createClass(CanvasEntry2, [{
              ...
              key: "fillRects",
              value: function fillRects(x2, y2, width, height, radius) {
                this.fillRectToContext(this.waveCtx, x2, y2, width, height, radius);
                if (this.hasProgressCanvas) {
                  this.fillRectToContext(this.progressCtx, x2, y2, width, height, radius);
                }
              }
            }, {
              key: "fillRectToContext",
              value: function fillRectToContext(ctx, x2, y2, width, height, radius) {
                if (!ctx) {
                  return;
                }
                if (radius) {
                  this.drawRoundedRect(ctx, x2, y2, width, height, radius);
                } else {
              ...
              key: "drawRoundedRect",
              value: function drawRoundedRect(ctx, x2, y2, width, height, radius) {
                if (height === 0) {
                  return;
                }
                if (height < 0) {
              ...
              value: function drawLineToContext(ctx, peaks, absmax, halfH, offsetY, start, end) {
                ...
                var j2 = canvasEnd - 1;
                for (j2; j2 >= canvasStart; j2--) {
                  peak = peaks[2 * j2 + 1] || 0;
                  h = Math.round(peak / absmaxHalf);
                  ctx.lineTo((j2 - first) * scale + this.halfPixel, halfOffset - h);
                }
        ...
        "./src/drawer.js": (module2, exports2, __webpack_require__2) => {
          ...
          function _setPrototypeOf(o2, p2) {
            _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf2(o22, p3) {
              o22.__proto__ = p3;
              return o22;
            };
          ...
          var Drawer2 = function(_util$Observer) {
            ...
            _createClass(Drawer3, [{
              ...
              value: function handleEvent(e2, noPrevent) {
                ...
                var clientX = util.withOrientation(e2.targetTouches ? e2.targetTouches[0] : e2, this.params.vertical).clientX;
              ...
              value: function getScrollX() {
                ...
                if (this.wrapper) {
                  ...
                  x2 = Math.round(this.wrapper.scrollLeft * pixelRatio);
                  if (this.params.scrollParent) {
                    var maxScroll = ~~(this.wrapper.scrollWidth * pixelRatio - this.getWidth());
                    x2 = Math.min(maxScroll, Math.max(0, x2));
                  }
                }
                return x2;
              }
        ...
        "./src/drawer.multicanvas.js": (module2, exports2, __webpack_require__2) => {
          ...
          var MultiCanvas = function(_Drawer) {
            ...
            _createClass(MultiCanvas2, [{
              ...
              key: "fillRect",
              value: function fillRect(x2, y2, width, height, radius, channelIndex) {
                var startCanvas = Math.floor(x2 / this.maxCanvasWidth);
                var endCanvas = Math.min(Math.ceil((x2 + width) / this.maxCanvasWidth) + 1, this.canvases.length);
                var i2 = startCanvas;
                for (i2; i2 < endCanvas; i2++) {
                  var entry = this.canvases[i2];
                  var leftOffset = i2 * this.maxCanvasWidth;
                  var intersection = {
                    x1: Math.max(x2, i2 * this.maxCanvasWidth),
                    y1: y2,
                    x2: Math.min(x2 + width, i2 * this.maxCanvasWidth + entry.wave.width),
                    y2: y2 + height
                  };
                  ...
                  if (peaks[0] instanceof Array) {
                    ...
                    if (_this7.params.splitChannels) {
                      ...
                      return channels.forEach(function(channelPeaks, i2) {
                        return _this7.prepareDraw(channelPeaks, i2, start, end, fn, filteredChannels.indexOf(channelPeaks), overallAbsMax);
                      });
                    }
                    peaks = channels[0];
                  }
          ...
          var PeakCache = function() {
            ...
            _createClass(PeakCache2, [{
              ...
              value: function addRangeToPeakCache(length, start, end) {
                ...
                while (i2 < this.peakCacheRanges.length && this.peakCacheRanges[i2] <= end) {
                ...
                this.peakCacheRanges = this.peakCacheRanges.sort(function(a2, b2) {
                  return a2 - b2;
        ...
        "./src/util/max.js": (module2, exports2) => {
          ...
          function max(values) {
            ...
            Object.keys(values).forEach(function(i2) {
              if (values[i2] > largest) {
                largest = values[i2];
              }
            });
            return largest;
        ...
        "./src/wavesurfer.js": (module2, exports2, __webpack_require__2) => {
          ...
          var WaveSurfer2 = function(_util$Observer) {
            ...
            _createClass(WaveSurfer3, [{
              ...
              value: function getArrayBuffer(url, callback) {
                ...
                this.tmpEvents.push(request.on("progress", function(e2) {
                  _this14.onProgress(e2);
                }), request.on("success", function(data) {
                  callback(data);
                  _this14.currentRequest = null;
                }), request.on("error", function(e2) {
            ...
            _createClass(WebAudio2, [{
              ...
              value: function setLength(length) {
                ...
                for (c2 = 0; c2 < channels; c2++) {
                  this.splitPeaks[c2] = [];
                  this.splitPeaks[c2][2 * (length - 1)] = 0;
                  this.splitPeaks[c2][2 * (length - 1) + 1] = 0;
                }
              ...
              value: function getPeaks(length, first, last) {
                ...
                for (c2 = 0; c2 < channels; c2++) {
                  ...
                  for (i2 = first; i2 <= last; i2++) {
                    ...
                    var max = min;
                    var j2 = void 0;
                    for (j2 = start; j2 < end; j2 += sampleStep) {
                      var value = chan[j2];
                      if (value > max) {
                        max = value;
                      }
                    ...
                    peaks[2 * i2] = max;
                    peaks[2 * i2 + 1] = min;
                    if (c2 == 0 || max > this.mergedPeaks[2 * i2]) {
                      this.mergedPeaks[2 * i2] = max;
                    }
                    if (c2 == 0 || min < this.mergedPeaks[2 * i2 + 1]) {
                      this.mergedPeaks[2 * i2 + 1] = min;
                    }
                  }
                }
                return this.params.splitChannels ? this.splitPeaks : this.mergedPeaks;
...
var WaveformWrapper = styled_components_browser_esm_default.div`
  ${({
  isActive
}) => Ae`
    display: flex;
...
var WaveformProgress = ({
  ...
  const waveformRef = (0, import_react2.useRef)(null);
  const {
    elementRefs,
    curAudioState
  } = useNonNullableContext(audioPlayerStateContext);
...
var ProgressContainer = styled_components_browser_esm_default.div`
  min-width: 100px;
`;
var Progress = () => {
  const {
  ...
  return jsxs(ProgressContainer, {
    className: "progress-container",
    children: [jsx(WaveformProgress, {
...
var Grid = $994c48bfb00b620b$export$ef2184bd89960b14;
var GridItem = (0, import_react2.forwardRef)(({
  children,
  visible = true,
  ...viewProps
}, ref) => {
  return jsx($b9606c0c41d55371$export$27a5bd065ad55220, {
    justifySelf: "center",
...
var VolumeSlider = ({
  ...
  const audioPlayerDispatch = useNonNullableContext(audioPlayerDispatchContext);
  const onChangeVolume = (0, import_react2.useCallback)((e2) => {
    e2.stopPropagation();
    e2.preventDefault();
    if (curAudioState.muted) {
      audioPlayerDispatch({
  ...
  return jsx(VolumeSliderContainer, {
...
var VolumeSliderContainer = styled_components_browser_esm_default.div`
  ${({
  contentPlacement,
  volumeValue
}) => Ae`
    ...
    ${contentPlacement === "top" && Ae`
      bottom: auto;
    `}

    ${contentPlacement === "left" && Ae`
      transform: rotate(-90deg);
      right: 50px;
    `}

    ${contentPlacement === "right" && Ae`
      transform: rotate(90deg);
      left: 50px;
    `}

    ${contentPlacement === "bottom" && Ae`
      transform: rotateX(180deg);
      top: 5px;
    `}
  ...
  `}
`;
var dropdownContext = (0, import_react2.createContext)(null);
var useDropdown = ({
  clickArea,
  triggerType,
  isOpen,
...
var DropdownContent = ({
  ...
  const [dropdownSize, setDropdownSize] = (0, import_react2.useState)();
  const {
    onClick
  } = useDropdown({
    setIsOpen,
  ...
  const Content = (0, import_react2.useMemo)(() => dropdownSize ? jsx(DropdownContentContainer, {
    ...dropdownContentProps,
    dropdownSize,
    placement,
    onClick,
...
var DropdownContentContainer = styled_components_browser_esm_default.div`
  ${({
  placement,
  dropdownSize
}) => Ae`
...
var useVolumeSliderPlacement = ({
  triggerRef,
  initialState
}) => {
  const { playerPlacement } = useNonNullableContext(audioPlayerStateContext);
  const [volumeSliderPlacement, setVolumeSliderPlacement] = (0, import_react2.useState)(initialState);
  (0, import_react2.useEffect)(() => {
...
var Volume = () => {
  ...
  return jsxs(Dropdown, {
    ...
    children: [jsx(Dropdown.Trigger, {
      children: jsx(VolumeTriggerBtn, {
        ref: triggerRef
      })
    }), jsx(Dropdown.Content, {
      children: jsx(VolumeSlider, {
        placement: contextVolumePlacement || volumeSliderPlacement
      })
    })]
  });
...
var Controller = () => {
  ...
  return jsxs(Fragment, {
    children: [jsx(Grid.Item, {
      ...
      visible: Boolean((_e2 = activeUI.repeatType) != null ? _e2 : activeUI.all),
      children: jsx(RepeatTypeBtn, {})
    }), jsx(Grid.Item, {
      ...
      children: jsxs($884c64d19340d345$export$f51f4c4ede09e011, {
        UNSAFE_className: "btn-wrapper",
        alignItems: "center",
        gap: "10px",
        children: [jsx(PrevNnextBtn, {
          type: "prev",
          visible: Boolean((_i = activeUI.prevNnext) != null ? _i : activeUI.all)
        }), jsx(PlayBtn, {}), jsx(PrevNnextBtn, {
          type: "next",
      ...
      children: jsx(SortablePlayList, {})
    })]
  });
};
var ArtworkContainer = styled_components_browser_esm_default.div`
  display: flex;
  align-items: center;
  width: 100%;
  height: 100%;
...
var TrackInfoContainer = styled_components_browser_esm_default.div`
  display: grid;
  align-items: center;
  row-gap: 5px;
  width: 200px;
...
var TrackInfo = () => {
  ...
  return jsx(TrackInfoContainer, {
    className: "track-info-container",
    children: (curPlayData == null ? void 0 : curPlayData.customTrackInfo) ? curPlayData.customTrackInfo : jsxs(Fragment, {
      children: [(curPlayData == null ? void 0 : curPlayData.name) && jsx("span", {
        className: "title",
        children: curPlayData.name
      }), (curPlayData == null ? void 0 : curPlayData.writer) && jsx("span", {
        className: "writer",
...
var TrackTimeContainer = styled_components_browser_esm_default.div`
  ${({ position, childrenClassName }) => Ae`
    display: flex;
    align-items: center;
    justify-content: center;
    min-height: 16px;
...
var Current = ({
  ...
  var _a;
  const trackCurTimeRef = (0, import_react2.useRef)(null);
  const {
    elementRefs
  } = useNonNullableContext(audioPlayerStateContext);
  useRefsDispatch({
  ...
  return jsx(TrackTimeCurrentContainer, {
    position,
...
var TrackTimeCurrentContainer = styled_components_browser_esm_default(TrackTimeContainer)`
  .track-current-time {
    font-weight: 700;
...
var Duration = ({
  ...
  var _a;
  const trackDurationRef = (0, import_react2.useRef)(null);
  const {
    elementRefs
  } = useNonNullableContext(audioPlayerStateContext);
  useRefsDispatch({
  ...
  return jsx(TrackTimeDurationContainer, {
    position,
...
var TrackTimeDurationContainer = styled_components_browser_esm_default(TrackTimeContainer)`
  .track-duration {
    display: flex;
...
var TrackTime = () => {
  ...
  const parsePosition = (0, import_react2.useCallback)((str) => +str.split(/[^\d]/).join(""), []);
  ...
  const getPosition = (0, import_react2.useCallback)((positionNumber) => {
  ...
  return jsxs(Fragment, {
    children: [jsx(Grid.Item, {
      gridArea: ((_e2 = interfacePlacement == null ? void 0 : interfacePlacement.itemCustomArea) == null ? void 0 : _e2.trackTimeCurrent) || ((_f = interfacePlacement == null ? void 0 : interfacePlacement.templateArea) == null ? void 0 : _f.trackTimeCurrent) || defaultInterfacePlacement.templateArea.trackTimeCurrent,
      visible: Boolean((_g = activeUI.trackTime) != null ? _g : activeUI.all),
      children: jsx(Current, {
...
var Information = () => {
  ...
  const isTrackInfoActive = Boolean((_e2 = (_c = (_a = playList[curIdx]) == null ? void 0 : _a.customTrackInfo) != null ? _c : (_b = playList[curIdx]) == null ? void 0 : _b.writer) != null ? _e2 : (_d = playList[curIdx]) == null ? void 0 : _d.name) && Boolean((_f = activeUI.trackInfo) != null ? _f : activeUI.all);
  return jsxs(Fragment, {
    children: [jsx(Grid.Item, {
      ...
      children: jsx(TrackInfo, {})
    }), jsx(TrackTime, {})]
  });
};
var useGridTemplate = (activeUI, templateArea, customComponentsArea) => {
  const generateGridTemplateValues = (0, import_react2.useCallback)(
    (activeUi, templatePlacement, customComponentsPlacement) => {
      ...
      }).sort((a2, b2) => a2.col - b2.col);
      const maxCol = Math.max(...Object.values(colsCntRecord));
      let progressColIdx;
      const gridAreas2 = new Array(maxRow).fill("").map((_2, rowIdx) => {
        var _a;
        let cols = "";
        ...
        if (isWithProgress) {
          ...
          for (let i2 = 0; i2 < maxCol - (progressCnt - 1); i2++) {
            if (((_a = curRowPlacementArr[i2]) == null ? void 0 : _a.key) === "progress") {
              cols += ` row${rowIdx + 1}-${curRowPlacementArr[i2].col} `.repeat(
                progressCnt
              );
              progressColIdx = Math.ceil(progressCnt / 2) + i2 - 1;
            } else {
              cols += ` row${rowIdx + 1}-${curRowPlacementArr[i2] ? curRowPlacementArr[i2].col : i2 + 1}`;
            }
          }
        } else {
      ...
      const gridColumns2 = new Array(maxRow).fill("").map((_2, rowIdx) => {
        let cols = "";
        for (let i2 = 0; i2 < maxCol; i2++) {
          if (progressColIdx === i2 && rowIdx === 0) {
            cols += ` 1fr`;
            continue;
          }
  ...
  const [curActiveUI, setCurActiveUI] = (0, import_react2.useState)(activeUI);
  const [curPlacementArea, setCurPlacementArea] = (0, import_react2.useState)({
    templateArea,
    customComponentsArea
  });
  const [curPlacementAreaValues, setCurPlacementAreaValues] = (0, import_react2.useState)();
...
var Interface = ({
  ...
  const CustomComponents = import_react2.default.Children.toArray(children);
  ...
  return jsxs(InterfaceContainer, {
    className: "interface-container",
    children: [playListPlacement === "top" && jsx("div", {
      ...
      children: [jsx(Information, {}), jsx(Controller, {}), CustomComponents]
    }), playListPlacement === "bottom" && jsx("div", {
      className: "sortable-play-list"
    })]
  });
};
var InterfaceContainer = styled_components_browser_esm_default.div`
  .interface-grid {
...
var AudioPlayer = ({
  ...
  return jsxs($b9606c0c41d55371$export$27a5bd065ad55220, {
    id: "rm-audio-player",
...
var AudioPlayerWithProviders = ({
  rootContainerProps,
  ...audioPlayProps
}) => {
  return jsx(AudioPlayerProvider, {
    ...audioPlayProps,
    children: jsxs(SpectrumProvider, {
      rootContainerProps,
      children: [jsx(AudioPlayer, {
        ...audioPlayProps
      }), jsx(GlobalStyle, {})]
    })
  });
...
var CustomComponent = ({
  ...
  return jsx(Grid.Item, {
    ...
    gridArea,
    ...gridItemProps,
    children: import_react2.default.cloneElement(children, {
      audioPlayerState
    })
  });
};
...
export {
  ...
  audioPlayerReducer,
  audioPlayerStateContext,
  AudioPlayerWithProviders as default,
...
react-modern-audio-player/dist/index.es.js:
  (**
   * @license React
...
react-modern-audio-player/dist/index.es.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=react-modern-audio-player.js.map
